...
function BasicExample() {
  ...
  return (
    <div className='xdd container abs-center'>
      <a className='continer icon' href='https://maps.app.goo.gl/AsxvMmLMAeHcVaTB9'  target='_blank'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2.5" stroke="#3ec03e" className="w-3 h-3">
      ...
      <div className='form'>
        ...
        <Form  onSubmit={enviar} >
          ...
          <Button type="submit"  color='#291800'>
            Submit
          </Button>
